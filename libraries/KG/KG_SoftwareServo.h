#ifndef KG_SoftwareServo_h
#define KG_SoftwareServo_h
//#include <Wiring.h>
#include <Arduino.h>
#include <inttypes.h>

class KG_SoftwareServo
{
  private:
    uint8_t pin;
    ...
    class  KG_SoftwareServo *next;
    static KG_SoftwareServo* first;
    public:
    ROBOT_KRUGOLF_SoftwareServo();
