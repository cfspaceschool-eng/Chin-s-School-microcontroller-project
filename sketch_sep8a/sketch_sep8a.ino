//no need for a stupid coment LOL buy my dumbass friend still coppy every single line of teacher's code bro think it youself bro🤣
#include<KG.h> //wait wait wait how the fuck can i get this libary i should ask my teacher for his own libary lol😂
void setup() 
{
